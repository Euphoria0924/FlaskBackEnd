...
from db_manipulate import create_task, search_task_result, show_all_tasks
...
@app.route('/regression_train', methods=['POST'])
def task_generate():
    """
    接收模型训练参数的接口
    参数：
